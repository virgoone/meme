			...
			<Popover open={open} onOpenChange={setOpen}>
				<PopoverTrigger asChild>
					...
					>
						...
						{sorting.length > 0 && (
							<Badge
								variant="secondary"
								className="h-[18.24px] px-[5.12px] font-mono font-normal text-[10.4px] [border-radius:var(--dt-control-radius)] [box-shadow:var(--dt-control-shadow)]"
							>
								{sorting.length}
							</Badge>
						)}
				...
				>
					...
					<div className="flex w-full items-center gap-2">
						<Button
							size="sm"
							className="[border-radius:var(--dt-control-radius)]"
							ref={addButtonRef}
							onClick={onSortAdd}
