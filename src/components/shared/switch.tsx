  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cx(
        ...
        `relative inline-flex ${trackDimensions} radix-state-checked:bg-blue-500 radix-state-unchecked:bg-gray-200 flex-shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75`,
      )}
    >
